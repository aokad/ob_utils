...
def merge_SVs(args):
    ...
    # sort_bp_bedpe(args.in_genomonsv, out_pref+".tmp1.sorted.bed", "GenomonSV")
    # sort_bp_bedpe(args.in_manta, out_pref+".tmp2.sorted.bed", "Manta")
    # sort_bp_bedpe(args.in_svaba, out_pref+".tmp3.sorted.bed", "SvABA")

    hOUT = open(out_pref + ".tmp12.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_genomonsv, "-b", args.in_manta], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp13.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_genomonsv, "-b", args.in_svaba], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp14.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_genomonsv, "-b", args.in_gridss], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp21.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_manta, "-b", args.in_genomonsv], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp23.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_manta, "-b", args.in_svaba], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp24.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_manta, "-b", args.in_gridss], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp31.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_svaba, "-b", args.in_genomonsv], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp32.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_svaba, "-b", args.in_manta], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp34.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_svaba, "-b", args.in_gridss], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp41.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_gridss, "-b", args.in_genomonsv], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp42.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_gridss, "-b", args.in_manta], stdout = hOUT)
    hOUT.close()
    hOUT = open(out_pref + ".tmp43.bedpe", 'w')
    subprocess.check_call(["bedtools", "pairtopair", "-a", args.in_gridss, "-b", args.in_svaba], stdout = hOUT)
    hOUT.close()
    ...
    annotate_other_sv(args.in_genomonsv, out_pref + ".tmp1.annotate.bedpe", sv_comp1, sv_comp2, sv_comp3, args.margin)
    ...
    annotate_other_sv(args.in_manta, out_pref + ".tmp2.annotate.bedpe", sv_comp1, sv_comp2, sv_comp3, args.margin)
    ...
    annotate_other_sv(args.in_svaba, out_pref + ".tmp3.annotate.bedpe", sv_comp1, sv_comp2, sv_comp3, args.margin)
    ...
    annotate_other_sv(args.in_gridss, out_pref + ".tmp4.annotate.bedpe", sv_comp1, sv_comp2, sv_comp3, args.margin)
    ...
    os.remove(out_pref + ".tmp.simple.txt")
    os.remove(out_pref + ".tmp.sequence.txt")
    os.remove(out_pref + ".tmp.exon2.txt")
