...
class Bed(object):
    ...
    def sname_value(info_string):
        ...
        '''
        value = Bed.parse_info_tag(info_string, 'SNAME=')
    ...
    def _update_sname_field(original_info1, original_info2):
        ...
        '''
        new_sname = Bed._combine_sname_values(
                Bed.sname_value(original_info1),
                Bed.sname_value(original_info2))
        if new_sname:
            return Bed.update_info_tag(original_info1, 'SNAME=', new_sname)
        else:
